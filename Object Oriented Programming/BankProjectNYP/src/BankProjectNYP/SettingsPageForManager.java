...
public class SettingsPageForManager extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SettingsPageForManager frame = new SettingsPageForManager(user,users,staffs);
	 ...
	 * Create the frame.
	 */
	public SettingsPageForManager(User user,HashMap<String,User> users,ArrayList<BankStaff> staffs) {
		...
		homeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					BankManagerHomePage homePage = new BankManagerHomePage(user, users,staffs);
