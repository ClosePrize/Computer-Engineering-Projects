...
public class Main {
	...
	public static void main(String[] args) {
        ...
        for(int i=0;i<10;i++) {
	        ...
	        System.out.println("Kare, Dikdörtgen, Yamuk, Paralelkenar şekillerinden hangisini tanımlamak istiyorsunuz?");
        ...
        for (int i = 0;i<10;i++) {
        	if(kareler[i] != null) {
        		...
        		double kütle = kareler[i].kütleHesapla();
            	System.out.println((i+1)+". Karenin Alanı: " + alan + "\n" + (i+1) +". Karenin Kütlesi: " + kütle);
            }
        	else {}
        }
        for (int i = 0;i<10;i++) {
        	if(dikdörtgenler[i] != null) {
        		...
        		double kütle = dikdörtgenler[i].kütleHesapla();
            	System.out.println((i+1)+". Dikdörtgenin Alanı: " + alan + "\n" + (i+1) + ". Dikdörtgenin Kütlesi: " + kütle);
            }
        	else {}
        }
        for (int i = 0;i<10;i++) {
        	if(yamuklar[i] != null) {
        		...
        		double kütle = yamuklar[i].kütleHesapla();
            	System.out.println((i+1)+". Yamuğun Alanı: " + alan + "\n" + (i+1) + ". Yamuğun Kütlesi: " + kütle);
            }
        	else {}
        }
        for (int i = 0;i<10;i++) {
        	if(paralelkenarlar[i] != null) {
        		...
        		double kütle = paralelkenarlar[i].kütleHesapla();
            	System.out.println((i+1)+". Paralelkenarın Alanı: " + alan + "\n" + (i+1) + ". Paralelkenarın Kütlesi: " + kütle);
            }
        	else {}
        }
    }	
